...
def compare_agreements(unseen_data, template_data):
    ...
    {unseen_data}
    Tasks:
    1. Identify any missing or altered clauses in the new contract compared to
    the template.
    2. Flag potential compliance risks based on GDPR regulations.
    3. Assign a risk score between 0 and 100 for the new contract (0 = no risk,
    100 = maximum risk).
    4. Provide reasoning for the assigned risk score.
    5. Suggest specific amendments or recommendations to bring the contract in
    line with current regulatory standards and best practices.
    ...
    - Reasoning: [...]
    - Recommendations: [...]
    Keep each section brief and focused on key points. Avoid long paragraphs or
    unnecessary details.
    """
